...
class MediaItemsControllerTest < ActionController::TestCase
  ...
  test "should create media_item" do
    assert_difference('MediaItem.count') do
      post :create, media_item: { date: @media_item.date, quote: @media_item.quote, source: @media_item.source, url: @media_item.url }
    end
  ...
  test "should update media_item" do
    put :update, id: @media_item, media_item: { date: @media_item.date, quote: @media_item.quote, source: @media_item.source, url: @media_item.url }
    assert_redirected_to media_item_path(assigns(:media_item))
  end
